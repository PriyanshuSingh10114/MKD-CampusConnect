      ...
      <Card className="bg-white dark:bg-layout-card-dark shadow-sm border-slate-200 dark:border-slate-800">
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 border dark:border-slate-800 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
              <div>
                <p className="font-semibold text-brand-primary">REC-MKD-101</p>
