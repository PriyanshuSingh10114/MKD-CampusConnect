...
router.patch('/:id/reset-password', roleMiddleware(['Super Admin', 'Principal']), userController.resetUserPassword);
router.delete('/:id', roleMiddleware(['Super Admin', 'Principal']), userController.deleteUser);
